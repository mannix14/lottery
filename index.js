	...
	function random(){
		...
		var powerBall = Math.floor(Math.random() * 26) + 1;
			...
			//CHECK FOR DUPLICATE
				...
				if (ball5 === ball1 || ball5 === ball2 || ball5 === ball3 || ball5 === ball4 || ball5 < 40) {
				var ball5 = Math.floor(Math.random() * 29) + 40;
			return ball5
		}
			...
			return ball3
						...
						else	if (ball2 === ball1 || ball2 === ball3 || ball2 === ball4 || ball2 === ball5) {
			var ball2 = Math.floor(Math.random() * 46) + 2;
				return ball2
			}

				else if (ball1 === ball2 || ball1 === ball3 || ball1 === ball4  || ball1 === ball5 || ball1 > 29) {
			var ball1 = Math.floor(Math.random() * 29) + 1;
			return ball1
			}
