	...
	function random(){
		...
		var ball1 = Math.floor(Math.random() * 21) +1;
		var ball2 = Math.floor(Math.random() * 31) + 20;
		var ball3 = Math.floor(Math.random() * 70);
		var ball4 = Math.floor(Math.random() * 70);
		var ball5 = Math.floor(Math.random() * 30) + 40;
